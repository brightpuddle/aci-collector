...
The `aci-collector` maintainers take all security issues in the project
...
`aci-collector` leverages GitHub's private vulnerability reporting.
...
reach out via the [Cisco Open security contact email](mailto:oss-security@cisco.com)E.
